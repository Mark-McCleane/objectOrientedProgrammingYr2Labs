...
public class ShowRectangleDemo extends Application {
  ...
  public void start(Stage primaryStage) {   
    ...
    Rectangle r1 = new Rectangle(25, 10, 60, 30); // position x and position y and size(w,h)
    r1.setStroke(Color.BLACK);
    r1.setFill(Color.WHITE);
    pane.getChildren().add(new Text(10, 27, "r1")); // co-ords and text
    ...
    r3.setArcWidth(15); 	//setting curve width 
    r3.setArcHeight(25);    //setting curve height 
